...
- Bump Java SDK from v7.18.1 to v8.29.0 ([#65](https://github.com/splendo/sentry-kotlin-multiplatform/pull/65))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8290)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.29.0)
