...
- Bump Java SDK from v7.18.1 to v8.2.0 ([#3](https://github.com/splendo/sentry-kotlin-multiplatform/pull/3))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#820)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.2.0)
