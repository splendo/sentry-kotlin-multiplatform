...
- Bump Java SDK from v7.18.1 to v8.24.0 ([#54](https://github.com/splendo/sentry-kotlin-multiplatform/pull/54))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.24.0)
