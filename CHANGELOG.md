...
- Bump Java SDK from v7.18.1 to v8.17.0 ([#37](https://github.com/splendo/sentry-kotlin-multiplatform/pull/37))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8170)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.17.0)
