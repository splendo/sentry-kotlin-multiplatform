...
- Bump Java SDK from v7.18.1 to v8.12.0 ([#23](https://github.com/splendo/sentry-kotlin-multiplatform/pull/23))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8120)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.12.0)
