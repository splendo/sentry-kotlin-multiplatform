...
- Bump Java SDK from v7.18.1 to v8.25.0 ([#55](https://github.com/splendo/sentry-kotlin-multiplatform/pull/55))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8250)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.25.0)
