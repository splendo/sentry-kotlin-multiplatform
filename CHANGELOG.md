...
- Bump Java SDK from v7.18.1 to v8.11.0 ([#18](https://github.com/splendo/sentry-kotlin-multiplatform/pull/18))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8110)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.11.0)
