...
- Bump Java SDK from v7.18.1 to v8.30.0 ([#66](https://github.com/splendo/sentry-kotlin-multiplatform/pull/66))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.30.0)
