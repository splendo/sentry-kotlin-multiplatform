...
- Bump Java SDK from v7.18.1 to v8.28.0 ([#63](https://github.com/splendo/sentry-kotlin-multiplatform/pull/63))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8280)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.28.0)
