...
- Bump Cocoa SDK from v8.44.0 to v8.54.0 ([#40](https://github.com/splendo/sentry-kotlin-multiplatform/pull/40))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8540)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.44.0...8.54.0)
