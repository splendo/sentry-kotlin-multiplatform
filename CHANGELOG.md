...
- Bump Cocoa SDK from v8.44.0 to v9.2.0 ([#67](https://github.com/splendo/sentry-kotlin-multiplatform/pull/67))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#920)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.44.0...9.2.0)
