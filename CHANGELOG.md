...
- Bump Cocoa SDK from v8.44.0 to v9.3.0 ([#69](https://github.com/splendo/sentry-kotlin-multiplatform/pull/69))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#930)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.44.0...9.3.0)
