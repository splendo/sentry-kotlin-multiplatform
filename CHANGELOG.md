...
- Bump Java SDK from v7.18.1 to v8.19.0 ([#41](https://github.com/splendo/sentry-kotlin-multiplatform/pull/41))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8190)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.19.0)
