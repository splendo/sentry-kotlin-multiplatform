...
- Bump Java SDK from v7.18.1 to v8.4.0 ([#8](https://github.com/splendo/sentry-kotlin-multiplatform/pull/8))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#840)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.4.0)
