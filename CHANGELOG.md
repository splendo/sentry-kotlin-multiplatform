...
- Bump Cocoa SDK from v8.44.0 to v9.1.0 ([#64](https://github.com/splendo/sentry-kotlin-multiplatform/pull/64))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#910)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.44.0...9.1.0)
