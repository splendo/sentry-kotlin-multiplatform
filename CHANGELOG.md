...
- Bump Java SDK from v7.18.1 to v8.15.0 ([#33](https://github.com/splendo/sentry-kotlin-multiplatform/pull/33))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8150)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.15.0)
