...
- Bump Java SDK from v7.18.1 to v8.18.0 ([#39](https://github.com/splendo/sentry-kotlin-multiplatform/pull/39))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8180)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.18.0)
