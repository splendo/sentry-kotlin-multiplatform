...
- Bump Cocoa SDK from v8.44.0 to v8.52.0 ([#29](https://github.com/splendo/sentry-kotlin-multiplatform/pull/29))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8520)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.44.0...8.52.0)
