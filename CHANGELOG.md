...
- Bump Cocoa SDK from v8.44.0 to v8.53.1 ([#34](https://github.com/splendo/sentry-kotlin-multiplatform/pull/34))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8531)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.44.0...8.53.1)
