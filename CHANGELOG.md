...
- Bump Java SDK from v7.18.1 to v8.20.0 ([#44](https://github.com/splendo/sentry-kotlin-multiplatform/pull/44))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8200)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.20.0)
