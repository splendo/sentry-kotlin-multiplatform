...
- Bump Java SDK from v7.18.1 to v8.23.0 ([#52](https://github.com/splendo/sentry-kotlin-multiplatform/pull/52))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8230)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.18.1...8.23.0)
